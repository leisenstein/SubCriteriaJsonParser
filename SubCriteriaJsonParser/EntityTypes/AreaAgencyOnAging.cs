...
namespace Snap.ForSeniors.Search2 {
    public class AreaAgencyOnAging : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.AreaAgencyOnAgingProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<AreaAgencyOnAging>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<AreaAgencyOnAging>(
                timerContext,
