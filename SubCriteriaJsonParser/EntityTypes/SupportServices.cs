...
namespace Snap.ForSeniors.Search2 {
    public class SupportServices : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.SupportServicesProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<SupportServices>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<SupportServices>(
                timerContext,
