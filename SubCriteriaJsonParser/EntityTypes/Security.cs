...
namespace Snap.ForSeniors.Search2 {
    public class Security : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.SecurityProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<Security>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<Security>(
                timerContext,
