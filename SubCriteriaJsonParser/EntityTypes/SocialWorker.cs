...
namespace Snap.ForSeniors.Search2 {
    public class SocialWorker : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.SocialWorkerProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<SocialWorker>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<SocialWorker>(
                timerContext,
