...
namespace Snap.ForSeniors.Search2 {
    public class Pharmacy : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.PharmacyProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<Pharmacy>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<Pharmacy>(
                timerContext,
