...
namespace Snap.ForSeniors.Search2 {
    public class Financial : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.FinancialProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<Financial>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<Financial>(
                timerContext,
