...
{
    public class MedicareDialysis : ISearch
    {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.MedicareDialysisNewest;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<MedicareDialysis>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<MedicareDialysis>(
                timerContext,
