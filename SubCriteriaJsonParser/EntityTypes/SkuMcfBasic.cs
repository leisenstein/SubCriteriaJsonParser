...
namespace Snap.ForSeniors.Search2 {
    public class SkuMcfBasic : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.SKU.MemoryCareFinder.Basic;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<SkuMcfBasic>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<SkuMcfBasic>(
                timerContext,
