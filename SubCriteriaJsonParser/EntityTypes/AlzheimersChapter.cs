...
namespace Snap.ForSeniors.Search2 {
    public class AlzheimersChapter : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.AlzheimersChapterProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<AlzheimersChapter>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<AlzheimersChapter>(
                timerContext,
