...
namespace Snap.ForSeniors.Search2 {
    public class HomeCare : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.HomeCareProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<HomeCare>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<HomeCare>(
                timerContext,
