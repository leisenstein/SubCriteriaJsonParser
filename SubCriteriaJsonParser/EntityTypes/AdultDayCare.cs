...
namespace Snap.ForSeniors.Search2 {
    public class AdultDayCare : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.AdultDayCareProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<AdultDayCare>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<AdultDayCare>(
                timerContext,
