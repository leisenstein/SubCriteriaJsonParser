...
namespace Snap.ForSeniors.Search2 {
    public class AgingAndDisabilityResourceCenter : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.AgingAndDisabilityResourceCenterProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<AgingAndDisabilityResourceCenter>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<AgingAndDisabilityResourceCenter>(
                timerContext,
