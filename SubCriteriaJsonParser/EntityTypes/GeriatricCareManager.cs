...
namespace Snap.ForSeniors.Search2 {
    public class GeriatricCareManager : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.GeriatricCareManagerProfileTemplateLabel;
            }
        }

        public GeoSearchType GeoSearch {
            get {
                return GeoSearchType.All;
            }
        }

        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<GeriatricCareManager>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<GeriatricCareManager>(
                timerContext,
