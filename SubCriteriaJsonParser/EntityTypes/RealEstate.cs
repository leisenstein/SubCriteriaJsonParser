...
namespace Snap.ForSeniors.Search2 {
    public class RealEstate : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.RealEstateProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<RealEstate>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<RealEstate>(
                timerContext,
