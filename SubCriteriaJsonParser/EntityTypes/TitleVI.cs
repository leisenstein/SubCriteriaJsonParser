...
namespace Snap.ForSeniors.Search2 {
    public class TitleVI : ISearch {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.TitleVIProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<TitleVI>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<TitleVI>(
                timerContext,
