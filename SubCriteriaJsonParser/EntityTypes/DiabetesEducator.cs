...
{
    public class DiabetesEducator : ISearch
    {
        ...
        public string ProfileTemplateLabel {
            get {
                return Snap.ForSeniors.Constants.DiabetesEducatorProfileTemplateLabel;
            }
        }
        ...
        public ResultSet Search(Params ps) {
            return Snap.Search2.Search.Do<DiabetesEducator>(ps);
        }
        ...
        public ResultSet Search(
            ...
            return Snap.Search2.Search.Do<DiabetesEducator>(
                timerContext,
